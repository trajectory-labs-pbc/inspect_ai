...
# Contract with the host bridge service (agent/_bridge/sandbox/service.py): a
# generate_* result carrying this key is a provider API error the host caught and
