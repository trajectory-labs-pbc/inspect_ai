...
export const ToolCallView: FC<ToolCallViewProps> = ({
  ...
  const annotation = useMemo<ToolAnnotation | undefined>(() => {
    ...
    if (nextVisualAction) {
      const action = nextVisualAction.action as string | undefined;
      if (action) {
        return {
          action,
          coordinate: nextVisualAction.coordinate as
            | [number, number]
            | undefined,
          text: nextVisualAction.text as string | undefined,
          scrollDirection: nextVisualAction.scroll_direction as
            | string
            | undefined,
        };
      }
