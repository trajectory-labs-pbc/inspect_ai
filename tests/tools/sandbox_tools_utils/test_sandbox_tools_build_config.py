...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            SandboxToolsBuildConfig(arch="arm64", version=200, fork_rev=42, suffix=None),
            "inspect-sandbox-tools-arm64-v200-tl42",
        ),
        (
            SandboxToolsBuildConfig(arch="amd64", version=123, fork_rev=1, suffix="dev"),
            "inspect-sandbox-tools-amd64-v123-tl1-dev",
        ),
        (
            SandboxToolsBuildConfig(arch="arm64", version=123, fork_rev=7, suffix="dev"),
            "inspect-sandbox-tools-arm64-v123-tl7-dev",
        ),
        (
            SandboxToolsBuildConfig(
